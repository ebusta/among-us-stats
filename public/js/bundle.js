...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addGroup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewGroup = exports.addNewPlayerInput = void 0;
...
var addPlayerButton = document.querySelector('.add-players');
...
if (newGroupForm) {
  newGroupForm.addEventListener('submit', function (e) {
    ...
    (0, _addGroup.createNewGroup)(groupName, pword, pwordConfirm, playerNamesArray);
  });
}

if (addPlayerButton) addPlayerButton.addEventListener('click', _addGroup.addNewPlayerInput);
